...
if($boton="Borrar Departamento" && isset($dep_reg) &&!empty($dep_reg)){
$linkPDO->exec("DELETE FROM departamento WHERE id_dep=$dep_reg");
}

if($boton="Guardar" && isset($dep) &&!empty($dep)){
$linkPDO->exec("INSERT INTO departamento (departamento) VALUES ('$dep')");
$consulta="INSERT INTO departamento (departamento) VALUES ('$dep')";
}
...
<form action="dep.php" method="get" name="dep" id="form_class">
...
<td width="400px" colspan="2"><input name="dep" type="text" placeholder="Departamento"/></td>
</tr>
...
<td>
<input type="submit" value="Borrar Departamento" name="boton" data-icon="delete" data-theme="a">
</td>
</tr>
<tr>
