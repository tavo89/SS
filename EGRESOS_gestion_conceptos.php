...
$columns=str_replace(' ', '',"id,des,sub_grupo");
...
$modColumns=str_replace(' ', '',"des,sub_grupo");
...
$ORDER_BY="ORDER BY sub_grupo,des";
...
$columnas2="cod_su,des,sub_grupo";
 
$tipoCol=array(0=>"hidden","text","text" );
$default=array(0=>"$codSuc","","");

 
//
crear_any_form("$tabla",$columnas2,$tipoCol,$default, " function(){ return true;}", "successAny","Concepto Gasto / Egreso","",$selecOPTColumns2);
?>
<h1 align="center"><i class="uk-icon uk-icon-object-group"></i> &nbsp;CONCEPTOS GASTOS / EGRESOS </h1>
...
function DEL_any(id)
{
	...
	ajax_x('ajax/FORMS/DEL_concepto_egreso.php',data,function(resp){
		
 		if(resp==1){
		simplePopUp("ELIMINADO");
		waitAndReload();	
		}
