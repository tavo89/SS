...
$total_vendedores=tot_nomina_cajas($fechaI,$fechaF,$codSuc,"","","",$clase,$fab,"C");
...
<tbody>
<?php
$rs=$linkPDO->query("SELECT vendedor from fac_venta WHERE nit=$codSuc AND (DATE(fecha)>='$fechaI' AND DATE(fecha)<='$fechaF' ) $filtroNOanuladas GROUP BY vendedor" );
$totVendedores=0;
