...
$sql_busq="SELECT  * FROM vista_inventario WHERE $F2 AND (id_glo LIKE '$busq%' OR detalle LIKE '$busq%' OR id_clase LIKE '$busq%' OR id_sede LIKE '$busq%')";
...
<!--
		...
		<a class="uk-navbar-brand uk-visible-large" href="centro.php"><img src="Imagenes/favSmart.png" class="icono_ss"> &nbsp;SmartSelling</a> 
			...
			<ul class="uk-navbar-nav uk-navbar-center" style="width:190px;">    
		
			 
				<li class="ss-navbar-center"><a href="Orden_pedido_excel.php"><i class="uk-icon-file-excel-o <?php echo $uikitIconSize ?>"></i>&nbsp;ROTACI&Oacute;N Excel</a></li>
...
<h1 align="center">ROTACI&Oacute;N</h1>
...
<!--<input data-inline="true" data-mini="true" type="text" name="pag" value=""  placeholder="P&aacute;gina" id="pag">
-->
</td>
...
<td colspan="3" align="center">Per&iacute;odo (2 meses atr&aacute;s por defecto):</td>
</tr>
<tr>
<TD>
<table>
...
<td align="left"><input type="submit" value="Dias" name="opc" data-inline="true" data-mini="true" class="uk-button uk-button-success" ></td>
</tr>
</table>
</TD>
...
<td align="right">
<input size="10" name="fechaI" value="<?php echo $fechaI ?>" type="date" id="f_ini" onClick="//popUpCalendar(this, form.f_ini, 'yyyy-mm-dd');"  placeholder="Fecha Inicial" style="margin-right:20px;">
</td>
<td>
...
<td style="padding-left:5px;"><?php echo $botonFiltro ?></td>
</tr>
</table>
<br><br><br>
...
<td style="font-size:10px;"><?php echo $des; ?></td>
<!-- <td align="right"><?php echo money3($costo); ?></td>-->
<td align="right"><?php echo $exist; ?></td>
<td align="right"><?php echo $Emn[$id][$nit_scs]; ?></td> 
<td align="right"><?php echo $Emx[$id][$nit_scs]; ?></td>
<td align="right"><?php echo $CP[$id][$nit_scs]; ?></td>
<td align="right"><?php echo $Pp[$id][$nit_scs]//." Dias: $DIAS, Dias Ventas: $tot_dias_ventas[$id]"//$fab ; ?></td> 
<td align="right"><?php echo $IR ?></td> 
<!--
<td align="left"><?php echo $SEDES2[$nit_scs]; ?></td></tr>
-->  
</tr>         
<?php 
}/////////////////////// FIN SIN ROTACION /////////////////////////////////////////////////////////
...
<td style="font-size:10px;"><?php echo $des; ?></td> 
<!-- <td align="right"><?php echo money3($costo); ?></td>-->
<td align="right"><?php echo $row['exist']; ?></td>
<td align="right"><?php echo $Emn[$id][$nit_scs]; ?></td> 
<td align="right"><?php echo $Emx[$id][$nit_scs]; ?></td>
<td align="right"><?php echo $CP[$id][$nit_scs]; ?></td>
<td align="right"><?php echo $Pp[$id][$nit_scs]//." Dias: $DIAS, Dias Ventas: $tot_dias_ventas[$id]"//$fab ; ?></td>
...
<td align="right"><?php echo $Emx[$id][$nit_scs]; ?></td>
<td align="right"><?php echo $CP[$id][$nit_scs]; ?></td>
<td align="right"><?php echo $Pp[$id][$nit_scs]//."<br>( $diasRotacion / $DIAS )* $tot_vendidos[$id]<br>Cp=$Cp[$id]<br>Cmn=$Cmn[$id]<br>Cmx=$Cmx[$id]<br>x=$xyz[$id]<br>inSeg: (sqrt($xyz[$id]/$DIAS)) * $Z*$t"//." Dias: $DIAS, Dias Ventas: $tot_dias_ventas[$id]"//$fab ; ?></td>  
<td align="right"><?php echo $IR ?></td>
<!--
<td align="left"><?php echo $SEDES2[$nit_scs]; ?></td></tr>
-->         
