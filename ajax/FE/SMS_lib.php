...
function getToken($mail,$pass,$auth_basic)
{
	global $enviar_sms;
	$urlApi= 'https://matias-api.com.co/api/ubl2.1';
	$pass='fc8eac422eba16e22ffd8c6f94b3f40a6e38162c';
	$mail='dario_123blanco@hotmail.com';
	$curl = curl_init();

//$POSTFIELDS='{"email":"'.$SMS.'", "password":"22435","remember_me":['.$telArray.']}';
$POSTFIELDS='{"email":"'.$SMS.'", "password":"22435","remember_me":0}';
//echo "$POSTFIELDS<br>";
