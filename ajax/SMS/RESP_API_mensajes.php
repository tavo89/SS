...
$sql="SELECT a.tel,a.id_cli,$limite_pago_facturas AS fecha_lim,  $dia_suspension AS fecha_sus FROM ($subQUERY) a INNER JOIN fac_venta b ON a.id_cli=b.id_cli AND b.".VALIDACION_VENTA_VALIDA." AND b.estado='PENDIENTE' WHERE $limite_pago_facturas<DATE(NOW()) GROUP BY a.tel";	
}
}
