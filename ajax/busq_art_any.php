...
$colBusq="inv_inter.id_inter = '$busq' OR ".tabProductos.".id_pro='$busq' OR fab LIKE '$busq%' OR $Sdetalle ";
$filtroCant=" AND (exist>0 OR unidades_frac>0) ";
if( $all==1)$filtroCant=" AND (exist>0 OR unidades_frac>0) ";
else $filtroCant="";
...
//eco_alert("row!");
		   include("busq_rows.php");
			$selFunct="$JS_function('$i','$id','$cod','$fe_ven');";
