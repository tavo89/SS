...
$codSuCol="cod_su";
$col_id="id_vehiculo";
$columns="id_vehiculo,placa,modelo,color,km,id_propietario";
$colSet= array(0=>"id_vehiculo","placa","modelo","color","km","id_propietario");
$url="lista_vehiculos.php";
$url_dialog="dialog_invIni.php";
$url_mod="modificar_inv.php";
$url_new="lista_vehiculos.php";
...
$sql = "SELECT  $columns FROM $tabla WHERE  $codSuCol=$codSuc ORDER BY km DESC    LIMIT $offset, $limit "; 
//echo $sql;
...
for($i=0;$i<$max;$i++){
	...
	if(gettype($row[$colSet[$i]||0])!="double"){echo "<td id=\"tabTD$ii".$i."\" onDblClick=\"$funct\">".$row[$colSet[$i]]."</td>";}
