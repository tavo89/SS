...
$NOMBRE_INFORME="CLIENTES ";
$url=thisURL();
$boton=r("boton");
if($boton=="MS EXCEL"){excel("Lista Clientes");}
$DCTO[]="";
$tipoD[]="";
$fabricante[]="";
$D="";
...
<th width="280">Tipo Usuario</th>
</tr>
</thead>
<tbody>
<?php
$ii=0;
$sql="SELECT a.* FROM usuarios a INNER JOIN (SELECT )  WHERE cliente=0 ";
        ...
        { type: 'numeric-comma', targets: 2 }],*/
			language: {url: 'locales/es.json'},
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excelHtml5', title: '<?php echo "$NOMBRE_INFORME";?> ', customize: function ( xlsx ){
                ...
                $('row c[r^="F"]', sheet).each( function () {
                    ...
                    {extend: 'pdf', title: '<?php echo "$NOMBRE_INFORME ";?> ' ,footer:true,orientation:'landscape',pageSize:'letter',
