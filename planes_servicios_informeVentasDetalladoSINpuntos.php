...
// fin saldo ant
   ...
   <?php }?>
    ...
    <td><?php echo ($excluidos) ?></td>
    <td><?php echo ($InteresMora) ?></td>
    <td><?php echo ($valorAfiliacionExenta) ?></td>
    <td><?php echo ($valorAfiliacionExcluida) ?></td>
    <td><?php echo ($valorAfiliacionGravada) ?></td>
    <td><?php echo ($saldoPeriodoAnt) ?></td>
