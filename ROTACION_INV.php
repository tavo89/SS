...
<!-- Lado izquierdo del Nav -->
		...
		<a class="uk-navbar-brand uk-visible-large" href="centro.php"><img src="Imagenes/favSmart.png" class="icono_ss"> &nbsp;SmartSelling</a> 
			...
			<ul class="uk-navbar-nav">   <!-- !!!!!!!!!! No se Puede centrar, navbar non-compliant !!!!!!!! -->
				...
				<li class="ss-navbar-center"><a style="cursor:pointer;" href="informe_SR_resumen_sedes.php"   ><i class="uk-icon-file-excel-o <?php echo $uikitIconSize ?>"></i>&nbsp;Sin rotaci&oacute;n RESUMEN</a></li>
		 
				
				
 
				<li class="uk-parent ss-navbar-center" data-uk-dropdown="{pos:'bottom-center',mode:'click'}" aria-haspopup="true" aria-expanded="false">
					<a style="cursor:pointer;" href="#"><i class="uk-icon-file-excel-o <?php echo $uikitIconSize ?>"></i> Reportes Excel</a>

					<div class="uk-dropdown uk-dropdown-navbar uk-dropdown-bottom" style="top: 40px; left: 0px;">
						<ul class="uk-nav uk-nav-navbar">
 
 
				<li><a style="cursor:pointer;" href="rotacion_productos.php"   target="blank"><i class="uk-icon-file-excel-o"></i>&nbsp;ROTACION</a></li>
...
<td>Existencias</td>
<td class="uk-hidden">Proveedores</td>
<td class="uk-hidden">Sede</td>
</tr>
<tr>
<td>
...
<tr>
<td class="uk-hidden">Dias Inventario:</td>
<td class="uk-hidden">Dias Entrega Proveedor:</td>
<td colspan="" align="center">Per&iacute;odo(6 meses atr&aacute;s por defecto):</td>
</tr>
<tr>
<TD class="uk-hidden">
<table>
...
<input size="15" name="fechaI" value="<?php echo $fechaI ?>" type="date" id="f_ini" onClick=" "  placeholder="Fecha Inicial" class="uk-form  "  >
</div>
</td>
<td>
 <div class="uk-form-icon">
...
<input size="15" value="<?php echo $fechaF ?>" type="date" name="fechaF" id="f_fin" onClick=" "  placeholder="Fecha Final" class="  "  >
</div>
</td>
...
{ 
			...
			$IR=$tot_vendidos[$id_inter][$nit_scs] + $tot_vendidosFrac[$id_inter][$nit_scs]/$frac;
