...
$columns=str_replace(' ', '',"id,nombre_ruta");
...
$modColumns=str_replace(' ', '',"nombre_ruta");
...
//
crear_any_form("$tabla",$columnas2,$tipoCol,$default, " function(){ return true;}", "successAny","Rutas Entrega","",$selecOPTColumns2);
?>
<h1 align="center"><i class="uk-icon uk-icon-envelope-o"></i> &nbsp;RUTAS DE ENTREGA FACTURAS </h1>
