...
-- Tiempo de generación: 17-05-2018 a las 19:48:09
...
--
-- Base de datos: `u155514936_fonde`
-- REEMPLAZAR : u155514936_fonde

DELIMITER $$
--
-- Procedimientos
--
CREATE DEFINER=`u155514936_fonde`@`10.1.2.54` PROCEDURE `FillCalendar` (`start_date` DATE, `end_date` DATE)  BEGIN
...
-- Funciones
--
CREATE DEFINER=`u155514936_fonde`@`10.1.2.54` FUNCTION `STRIP_NON_DIGIT` (`input` VARCHAR(255)) RETURNS VARCHAR(255) CHARSET utf8 COLLATE utf8_unicode_ci BEGIN
...
(132, 'ID_CLI_DCTO_ESPECIAL_1', '0', 1),
(133, 'ID_CLI_DCTO_ESPECIAL_2', '0', 1),
(101, 'IGLESIAS', '0', 1),
...
(136, 'label_pvp_mayo', 'PvP Mayorista', 1),
(54, 'lim_dcto', '30.5', 1),
(86, 'LIM_FAC_REMI', '0', 1),
...
(129, 'usar_datos_motos', '0', 1),
(130, 'usar_fracciones_unidades', '0', 1),
(18, 'usar_iva', '1', 1),
(49, 'usar_posFac', '0', 1),
...
ALTER TABLE `art_fac_com`
  ...
  ADD KEY `cod_barras` (`cod_barras`),
  ADD KEY `cod_barras_2` (`cod_barras`),
...
ALTER TABLE `art_fac_remi`
  ...
  ADD UNIQUE KEY `num_fac_ven_2` (`num_fac_ven`,`ref`,`sub_tot`,`nit`,`prefijo`,`cod_barras`,`fecha_vencimiento`),
  ADD UNIQUE KEY `num_fac_ven_3` (`num_fac_ven`,`ref`,`sub_tot`,`nit`,`prefijo`,`cod_barras`,`fecha_vencimiento`),
  ADD KEY `num_fac_ven` (`num_fac_ven`),
  ADD KEY `nit` (`nit`),
  ADD KEY `ref` (`ref`),
  ADD KEY `iva` (`iva`),
...
ALTER TABLE `art_fac_ven`
  ...
  ADD KEY `des` (`des`),
  ADD KEY `cod_garantia` (`cod_garantia`),
  ADD KEY `cod_garantia_2` (`cod_garantia`),
  ADD KEY `cod_garantia_3` (`cod_garantia`),
  ADD KEY `linea` (`linea`,`modelo`,`num_motor`,`num_chasis`,`cilindraje`,`consecutivo_proveedor`);
...
--
-- Indices de la tabla `inv_inter2`
--
ALTER TABLE `inv_inter2`
  ADD PRIMARY KEY (`id_pro`,`nit_scs`,`id_inter`,`fecha_vencimiento`),
  ADD UNIQUE KEY `serial_inv` (`serial_inv`),
  ADD KEY `nit_scs` (`nit_scs`),
  ADD KEY `id_pro` (`id_pro`),
...
--
ALTER TABLE `exp_anticipo`
  MODIFY `id_anti` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT de la tabla `inv_inter2`
--
ALTER TABLE `inv_inter2`
  MODIFY `serial_inv` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `municipio`
  MODIFY `id_mun` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `seriales`
  MODIFY `id_serial` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;
...
--
ALTER TABLE `sub_clase`
  MODIFY `id_sub_clase` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `x_config`
  MODIFY `id_config` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;
