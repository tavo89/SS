...
<span align="center"><B>Base de Datos de Productos</B></span>
</p>
</td>

</tr>
</table>
<span style="font-size:16px; font-weight:bold">Fecha: <?PHP echo $hoy ?></span>
<br>
<table align="center" width="100%">
<tr>
<td colspan="3">
...
<th width="100" align="center">C&oacute;digo</th>
<th width="350">Descripci&oacute;n</th>
<th width="150">Costo</th>

<th width="150">PVP</th>
<th width="150"> Mayorista</th>
...
$sql = "SELECT  $columns FROM ".tabProductos." INNER JOIN inv_inter ON ".tabProductos.".id_pro=inv_inter.id_pro WHERE  nit_scs=$codSuc ORDER BY detalle LIMIT 1800";
...
<td align="center"><?php echo $row['id_sede']; ?></td>
<td><?php echo $des; ?></td> 
<td><?php echo money2($row['costo']*1); ?></td>

<td><?php echo money2($row['precio_v']*1); ?></td>
<td><?php echo money2($row['pvp_may']*1); ?></td>

<td><?php echo $row['exist']*1; ?></td>
		...
		$('.tablaDataTables').DataTable({
			language: {url: 'locales/es.json'},
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excelHtml5', title: 'Informe Egresos '+rangoFecha,footer:true, customize: function ( xlsx ){
                ...
                $('row c[r^="F"]', sheet).each( function () {
                    ...
                    {extend: 'pdf', title: 'Informe Egresos '+rangoFecha,footer:true,orientation:'landscape',pageSize:'letter',
					customize: function ( doc ) {
                // Splice the image in after the header, but before the table
				// 							      1     2      3      4      5      6     7  
				doc.content[1].table.widths = [ '15%', '15%', '25%', '15%', '15%', '15%', '5%'];
