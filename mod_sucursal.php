...
$sql="UPDATE sucursal SET cod_contado='$pre', resol_contado='$resol',fecha_resol_contado='$feResol',rango_contado='$rangoFac' WHERE cod_su=$codSuc";
$linkPDO->exec($sql);


$sql="UPDATE seriales SET serial_sup='$sup', serial_inf='$inf' WHERE seccion='factura venta' AND nit_sede=$codSuc";
$linkPDO->exec($sql);
...
<li class="uk-active"><a href="mod_sucursal.php">POS</a></li>
...
$rango=$row['rango_contado'];
 ...
 ?>
<form action="mod_sucursal.php" method="get" id="frm" class="uk-form">
...
<tr>
<th colspan="4" style="font-size:24px">Datos Resol. DIAN (POS)</th>
</tr>
