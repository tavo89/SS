...
if($fac_servicios_mensuales==1){$columns=str_replace(' ', '',"id,nombre_servicio,precioplan,equipreco,servadic,tipo_cliente");}
else{$columns=str_replace(' ', '',"id,estrato,anchobanda,precioplan,velbajada,velsubida,equipreco,servadic,tipo_cliente");}

if($fac_servicios_mensuales==1){$modColumns=str_replace(' ', '',"nombre_servicio");}
else{$modColumns=str_replace(' ', '',"estrato");}
$modColumns=explode(",",$modColumns);

$hidColumns=str_replace(' ', '',"");
...
$selecColumns=str_replace(' ', '',"tipo_cliente");
...
$url="servicios_gestion_planes_internetListado.php";
if($fac_servicios_mensuales==1){$ORDER_BY="ORDER BY nombre_servicio,precioplan ";}
else{$ORDER_BY="ORDER BY estrato,velbajada ";}
...
if($fac_servicios_mensuales==1){
$columnas2="cod_su,nombre_servicio,precioplan,equipreco,servadic,tipo_cliente";
$tipoCol=array(0=>"hidden","text","text","text","text","select" );
$default=array(0=>"$codSuc","","","","","" );
}
else{

$columnas2="cod_su,estrato,anchobanda,precioplan,velbajada,velsubida,equipreco,servadic,tipo_cliente";
$tipoCol=array(0=>"hidden","text","text","text","text","text","text","text" ,"select" );
$default=array(0=>"$codSuc","","","","","","","","" );
}

crear_any_form("$tabla",$columnas2,$tipoCol,$default, " function(){ return true;}", "successAny","Planes Internet $SEDES[$codSuc]","",$selecOPTColumns2);


?>
<h1 align="center">PLANES DE INTERNET </h1>
...
function DEL_any(id)
{
	...
	ajax_x('ajax/FORMS/DEL_servicio_internet_lista_planes.php',data,function(resp){
