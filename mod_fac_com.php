      ...
      <ul class="uk-navbar-nav uk-navbar-center" style="">
       ...
       <li class="ss-navbar-center"><a href="ReporteExcelCompra.php"  ><i class="uk-icon-list <?php echo $uikitIconSize ?>"></i>&nbsp;Listado Productos</a></li>
        ...
        <div class="uk-navbar-content uk-navbar-flip  uk-hidden-small">
          <div class="uk-button-group"> <a class="uk-button uk-button-danger uk-button-large" href="compras.php">Volver</a>
...
<input type="submit" value="Eliminar Casillas Vacias" name="boton" id="boton3" class="uk-button uk-button-danger">
        <?php
					...
					?>
                  <input type="submit" value="Eliminar TODO" name="boton" id="boton4" class="uk-button uk-button-danger">
                  <?php }?>
</div>
</form>
...
$serial_compra=$row['serial_fac_com'];
...
$subtot=$row['subtot'];
$iva=$row['iva'];
$impuesto_consumo=$row['impuesto_consumo'];
...
?>
<div id="fac_com">
<table frame="box" align="left" cellspacing="0" class="round_table_gray tabla-datos" id="tab_compra" style="font-size:20px">
<tbody>
        <tr>
          <td colspan="15">
          <table frame="box" rules="rows" width="100%">
              <tr>
                <td  align="left" colspan="3"><table align="left" cellspacing="0">
                    <tr>
                      <td   colspan="2" class="uk-text-large">Fecha:
                       <input  id="fecha2" type="date" value="<?php echo $fecha ?>" name="fecha"  class="save_fc " style="width:200px;" /><i class="uk-icon-calendar uk-icon-medium"></i>

    </td>
                      <td colspan="" align="right" class="uk-text-large uk-text-bold" >
                      <h1 class="uk-text-danger uk-text-bold">FACTURA</h1></td>
                      <td valign="top" colspan="2">&nbsp;
                        <input name="num_fac" type="text" id="num_fac" value="<?php echo $num_fac ?>" onChange="val_mod_fc($('#num_fac').val(),$('#nit').val(),'fac_com','num_fac_com','nit_pro',$('#resp'),'<?php echo $nit_proH ?>','<?php echo $num_facH?>');" onBlur="//nan($(this))" class="save_fc uk-form-danger uk-form-large" style="width:200px; font-size:28px;"/></td>
                    </tr>
                    <tr>
                      <td colspan="2" class="uk-text-large">Vencimiento:   <input  id="fechaVen" type="date" value="<?php echo $fechaVen ?>" name="fechaVen"  class="save_fc" style="width:200px;" /> <i class="uk-icon-calendar uk-icon-medium"></i></td>
                    ...
                    <tr style="font-weight:bold;"  >
                      ...
                      <td colspan="2"><input type="hidden" value="" name="CNC" id="CNC" onChange="useDB($(this));" class="">
                ...
                <td  colspan="" >Proveedor:
                  <table border="0" width="100%">
                    <tr>
                      ...
                      <td colspan="3">
<select data-placeholder="Escriba Nombre Proveedor" class="chosen-select " name="n_pro" id="n_pro" onChange="nom_pro(this);val_mod_fc($('#num_fac').val(),$('#nit').val(),'fac_com','num_fac_com','nit_pro',$('#resp'),'<?php echo $nit_proH ?>');"  style="width:200px; font-size:18px;">
			...
			?>
                ...
                <td>NIT:
                  <input   style="width:100px;" name="nit" type="text" id="nit" value="<?php echo $nit_pro ?>" onChange="pro(this.value);" class="save_fc"/></td>
                <td colspan="">&nbsp;&nbsp;&nbsp;Mail:
        ...
        <tr>
          ...
          <table id="articulos" width="100%" cellspacing="0" cellpadding="0" frame="box" rules="cols" style="border-width:1px" class="tabla_inv">
              <tr class="data-uk-sticky">
                ...
                <td class="<?php  if($usar_ubica==0){echo " uk-hidden";}?>"><div align="center" style=" border-bottom-style:solid; border-bottom-width:1px"><strong>Ubicacion</strong></div></td>
                <?php if($usar_color==1){ ?>
                ...
                <td><div align="center" style=" border-bottom-style:solid; border-bottom-width:1px"><strong>Consecutivo Prov</strong></div></td>

                <?php }?>

                <?php if($ropa_campos_extra==1){ ?>
                <td><div align="center" style=" border-bottom-style:solid; border-bottom-width:1px"><strong>Cod. Color</strong></div></td>
                <td><div align="center" style=" border-bottom-style:solid; border-bottom-width:1px"><strong>Vigencia</strong></div></td>
                <td><div align="center" style=" border-bottom-style:solid; border-bottom-width:1px"><strong>Grupo Destino</strong></div></td>
                ...
                <?php }?>
                       ...
                       <?php if($usar_campos_01_02==1){?>
                <td><div align="center" style=" border-bottom-style:solid; border-bottom-width:1px"><strong><?php echo $label_campo_add_01;?></strong></div></td>
<td><div align="center" style=" border-bottom-style:solid; border-bottom-width:1px"><strong><?php echo $label_campo_add_02;?></strong></div></td>
                <?php }?>
                ...
                <?php
				$classHide_consumo=' uk-hidden';
				if($impuestos_consumo==1){$classHide_consumo=' ';}?>

                <td ><div align="center" style=" border-bottom-style:solid; border-bottom-width:1px"><strong>Imp.Saludable</strong></div></td>
                <td ><div align="center" style=" border-bottom-style:solid; border-bottom-width:1px"><strong>IVA</strong></div></td>
                <td  class="<?php echo "$classHide_consumo";?>"><div align="center" style=" border-bottom-style:solid; border-bottom-width:1px"><strong>Imp.Consumo</strong></div></td>
                ...
                <td><div align="center" style=" border-bottom-style:solid; border-bottom-width:1px"><strong><?php echo "$label_pvp_mayo";?></strong></div></td>
                <?php } ?>
...
while($row=$rs->fetch())
{
	...
	if($No%2==0)$rgb="#999999";
		...
		$impuesto_consumoRow=$row["impuesto_consumo"]*1;
    $impuesto_saludable=$row["impuesto_saludable"]*1;

		//echo "<tr><td>supera los segundos $diffFechaCrea $hoy-$feCrea</td></tr>";
		//!$timeOutValidate && (empty($cod_bar))
		$timeOutValidate=$diffFechaCrea>300;
		if(1){
...
?>
              <tr style="background-color:<?php echo $rgb ?>;" tabindex="0" id="tr<?php echo $i ?>" onClick="//click_ele(this);" onBlur="//resetCss(this);">
                ...
                <!-- cod Barras -->
                <td class="art<?php echo $i ?>" align="center" valign="top" colspan=""><input onkeyup="" class="art<?php echo $i ?> fc_codBarras" name="cod_bar<?php echo $i ?>" id="cod_bar<?php echo $i ?>" value="<?php echo $cod_bar?>"  type="text" onChange="save_fc(<?php echo $i ?>);dup_cam($('#cod_bar<?php echo $i ?>'),$('#cod_barH<?php echo $i ?>'));"    >
                ...
                <td class="art<?php echo $i ?>" align="center" valign="top" colspan="2"><input onkeyup="//cod(this,'add',0,0)" class="art<?php echo $i ?> fc_ref" name="ref<?php echo $i ?>" id="ref<?php echo $i ?>" value="<?php echo $ref ?>" type="text"   onChange="save_fc(<?php echo $i ?>);dup_cam($('#ref<?php echo $i ?>'),$('#refH<?php echo $i ?>'));"   >
    ...
    <!--  SERIAL & CERT. IMPORT -->
     <?php if($usar_serial==1){ ?><td class="art<?php echo $i ?>" align="center" valign="top" colspan="2"><input onkeyup="" class="art<?php echo $i ?> fc_ref" name="serial_art<?php echo $i ?>" id="serial_art<?php echo $i ?>" value="<?php echo $serial ?>" type="text"   onChange="save_fc(<?php echo $i ?>);"   ></td> <?php } ?>

      <?php if($cert_import==1){ ?><td class="art<?php echo $i ?>" align="center" valign="top" colspan="2"><input onkeyup="" class="art<?php echo $i ?> fc_ref" name="cert_import<?php echo $i ?>" id="cert_import<?php echo $i ?>" value="<?php echo $certImport ?>" type="text"   onChange="save_fc(<?php echo $i ?>);"   ></td> <?php } ?>

                <!-- cant -->
                <td class="art<?php echo $i ?>" align="center" valign="top"><input  class="art<?php echo $i ?> fc_cant" name="cant<?php echo $i ?>" id="cant<?php echo $i ?>" value="<?php echo $cant ?>" onkeyup="calc_uni($('#cant<?php echo $i ?>'),$('#fracc<?php echo $i ?>'),$('#unidades<?php echo $i ?>'));tot();save_fc(<?php echo $i ?>);" type="text" onBlur="cant_dcto_com($('#tipo_dcto<?php echo $i ?>'),$('#dct<?php echo $i ?>'),$('#cant<?php echo $i ?>'));">
                ...
                <?php if($usar_fracciones_unidades==1){ ?>
                <!-- fraccion -->
                <td class="art<?php echo $i ?>" align="center" valign="top" colspan=""><input onkeyup="calc_uni($('#cant<?php echo $i ?>'),$('#fracc<?php echo $i ?>'),$('#unidades<?php echo $i ?>'));tot();save_fc(<?php echo $i ?>);" class="art<?php echo $i ?> fc_frac" name="fracc<?php echo $i ?>" id="fracc<?php echo $i ?>" value="<?php echo $row['fraccion']?>"  type="text" onBlur=""></td>
                <td class="art<?php echo $i ?>" align="center" valign="top" colspan=""><input onkeyup="calc_cant($('#cant<?php echo $i ?>'),$('#fracc<?php echo $i ?>'),$('#unidades<?php echo $i ?>'));tot();save_fc(<?php echo $i ?>);" class="art<?php echo $i ?>" name="unidades<?php echo $i ?>" id="unidades<?php echo $i ?>" value="<?php echo $row['unidades_fraccion'];?>" style="width:40px;top:10px" type="text" onChange=""></td>
                <?php }

				else{
					?>
					<td class="art<?php echo $i ?> uk-hidden" align="center" valign="top" colspan=""><input onkeyup="calc_uni($('#cant<?php echo $i ?>'),$('#fracc<?php echo $i ?>'),$('#unidades<?php echo $i ?>'));tot();" class="art<?php echo $i ?> fc_frac" name="fracc<?php echo $i ?>" id="fracc<?php echo $i ?>" value="<?php echo $row['fraccion']?>"  type="text" onBlur="save_fc(<?php echo $i ?>);"></td>
                <td class="art<?php echo $i ?> uk-hidden" align="center" valign="top" colspan=""><input onkeyup="calc_cant($('#cant<?php echo $i ?>'),$('#fracc<?php echo $i ?>'),$('#unidades<?php echo $i ?>'));tot();" class="art<?php echo $i ?>" name="unidades<?php echo $i ?>" id="unidades<?php echo $i ?>" value="<?php echo $row['unidades_fraccion'];?>" style="width:40px;top:10px" type="text" onChange="save_fc(<?php echo $i ?>);"></td>
					<?php
					}
                ...
                <!-- descripcion -->
                <td class="art<?php echo $i ;?>" align="center" valign="top"><textarea  class="art<?php echo $i ?> fc_des" name="des<?php echo $i ?>" id="des<?php echo $i ?>" value=""  onBlur="save_fc(<?php echo $i ?>);"><?php echo $des ?></textarea></td>


                <?php if($MODULES["DES_FULL"]==1){ ?>

                         <!-- descripcion FUL -->
                <td class="art<?php echo $i ?>" align="center" valign="top"><textarea  class="art<?php echo $i ?> fc_des_full" name="des_full<?php echo $i ?>" id="des_full<?php echo $i ?>" value=""  onBlur="save_fc(<?php echo $i ?>);"><?php echo $des_full ?></textarea></td>
                <?php } ?>

                <!-- ubicacion -->
                <td class="art<?php echo $i; if($usar_ubica==0){echo " uk-hidden";} ?>" align="center" valign="top" colspan=""><input onkeyup="" class="art<?php echo $i ?> fc_color" name="ubicacion<?php echo $i ?>" id="ubicacion<?php echo $i ?>" value="<?php echo $ubicacion?>"  type="text" onBlur="save_fc(<?php echo $i ?>);"></td>
                <?php if($usar_color==1){ ?>
                <!-- color -->
                <td class="art<?php echo $i ?>" align="center" valign="top" colspan=""><input onkeyup="" class="art<?php echo $i ?> fc_color" name="color<?php echo $i ?>" id="color<?php echo $i ?>" value="<?php echo $color?>"  type="text" onChange="save_fc(<?php echo $i ?>);"></td>
                <?php } ?>

 <!-- Datos Extra Ropa -->

 <?php if($ropa_campos_extra==1){ ?>
<td class="art<?php echo $i ?>" align="center" valign="top" colspan=""><input onkeyup="" class="art<?php echo $i ?> fc_color" name="cod_color<?php echo $i ?>" id="cod_color<?php echo $i ?>" value="<?php echo $row["cod_color"];?>"  type="text" onChange="save_fc(<?php echo $i ?>);"></td>

<td class="art<?php echo $i ?>" align="center" valign="top" colspan=""><input onkeyup="" class="art<?php echo $i ?> fc_seriales" name="vigencia_inicial<?php echo $i ?>" id="vigencia_inicial<?php echo $i ?>" value="<?php echo $row["vigencia_inicial"];?>"  type="text" onChange="save_fc(<?php echo $i ?>);"></td>

<td class="art<?php echo $i ?>" align="center" valign="top" colspan=""><input onkeyup="" class="art<?php echo $i ?> fc_color" name="grupo_destino<?php echo $i ?>" id="grupo_destino<?php echo $i ?>" value="<?php echo $row["grupo_destino"];?>"  type="text" onChange="save_fc(<?php echo $i ?>);"></td>
  <?php } ?>

                <!-- Datos Motos/Vehiculos -->


                <?php if($usar_datos_motos==1){ ?>
<td class="art<?php echo $i ?>" align="center" valign="top" colspan=""><input onkeyup="" class="art<?php echo $i ?> fc_color" name="linea<?php echo $i ?>" id="linea<?php echo $i ?>" value="<?php echo $row["linea"]?>"  type="text" onChange="save_fc(<?php echo $i ?>);"></td>

<td class="art<?php echo $i ?>" align="center" valign="top" colspan=""><input onkeyup="" class="art<?php echo $i ?> fc_color" name="modelo<?php echo $i ?>" id="modelo<?php echo $i ?>" value="<?php echo $row["modelo"];?>"  type="text" onChange="save_fc(<?php echo $i ?>);"></td>

<td class="art<?php echo $i ?>" align="center" valign="top" colspan=""><input onkeyup="" class="art<?php echo $i ?> fc_seriales" name="num_motor<?php echo $i ?>" id="num_motor<?php echo $i ?>" value="<?php echo $row["num_motor"]?>"  type="text" onChange="save_fc(<?php echo $i ?>);"></td>

<td class="art<?php echo $i ?>" align="center" valign="top" colspan=""><input onkeyup="" class="art<?php echo $i ?> fc_seriales" name="num_chasis<?php echo $i ?>" id="num_chasis<?php echo $i ?>" value="<?php echo $row["num_chasis"]?>"  type="text" onChange="save_fc(<?php echo $i ?>);"></td>

<td class="art<?php echo $i ?>" align="center" valign="top" colspan=""><input onkeyup="" class="art<?php echo $i ?> fc_color" name="cilindraje<?php echo $i ?>" id="cilindraje<?php echo $i ?>" value="<?php echo $row["cilindraje"]?>"  type="text" onChange="save_fc(<?php echo $i ?>);"></td>

<td class="art<?php echo $i ?>" align="center" valign="top" colspan=""><input onkeyup="" class="art<?php echo $i ?> fc_seriales" name="consecutivo_proveedor<?php echo $i ?>" id="consecutivo_proveedor<?php echo $i ?>" value="<?php echo $row["consecutivo_proveedor"]?>"  type="text" onChange="save_fc(<?php echo $i ?>);"></td>
                ...
                <?php if($usar_talla==1){ ?>
                <!-- talla -->
                <td class="art<?php echo $i ?>" align="center" valign="top" colspan=""><input onkeyup="" class="art<?php echo $i ?> fc_talla" name="talla<?php echo $i ?>" id="talla<?php echo $i ?>" value="<?php echo $talla?>" type="text"  onChange="save_fc(<?php echo $i ?>);" ></td>
                <?php } ?>

                <!-- presentacion -->
                <td class="art<?php echo $i ?>" align="center" valign="top" colspan=""><input onkeyup="" class="art<?php echo $i ?> fc_presentacion" name="presentacion<?php echo $i ?>" id="presentacion<?php echo $i ?>" value="<?php echo $presentacion?>"  type="text"  onChange="save_fc(<?php echo $i ?>);" ></td>

                <!-- fabricante -->
                <td class="art<?php echo $i ?>" align="center" valign="top" colspan=""><input onkeyup="" class="art<?php echo $i ?> fc_fab" name="fabricante<?php echo $i ?>" id="fabricante<?php echo $i ?>" value="<?php echo $fabricante?>"  type="text"  onChange="save_fc(<?php echo $i ?>);" ></td>

                <!-- clase -->
<td class="art<?php echo $i ?>" align="center" valign="top" colspan="">
	<input type="text" onkeyup="" class="art<?php echo $i ?> fc_clase"  name="clase<?php echo $i ?>" id="clase<?php echo $i ?>" value="<?php echo $clase?>"   onChange="save_fc(<?php echo $i ?>);" >


	<!--<select class="art<?php echo $i ?> fc_clase"  name="clase<?php echo $i ?>" id="clase<?php echo $i ?>" value="<?php echo $clase?>"   onChange="save_fc(<?php echo $i ?>);" >
		<?php
		...
		?>
                ...
                ?>
                <!-- Aplica Vehi -->
                <td class="art<?php echo $i ?>" align="center" valign="top"><input type="text"  class="art<?php echo $i ?> fc_aplica_vehi" name="aplica_vehi<?php echo $i ?>" id="aplica_vehi<?php echo $i ?>" value="<?php echo $aplica_vehi ?>"  onBlur="save_fc(<?php echo $i ?>);"></td>
                ...
                <?php if($usar_fecha_vencimiento==1){ ?>
                <!-- fecha vencimiento -->
                <td class="art<?php echo $i ?>" align="center" valign="top" colspan=""><input onkeyup="" class="art<?php echo $i ?> fc_fechaVen" name="fecha_vencimiento<?php echo $i ?>" id="fecha_vencimiento<?php echo $i ?>" value="<?php echo $row['fecha_vencimiento']?>"type="date"  onBlur="save_fc(<?php echo $i ?>);dup_cam($('#fecha_vencimiento<?php echo $i ?>'),$('#fecha_vencimientoH<?php echo $i ?>'));" >
                ...
                <?php if($usar_campos_01_02==1){ ?>
                <td class="art<?php echo $i ?>" align="center" valign="top"><input type="text"  class="art<?php echo $i ?> fc_codBarras" name="campo_add_01<?php echo $i ?>" id="campo_add_01<?php echo $i ?>" value="<?php echo $campo_add_01 ?>"  onBlur="save_fc(<?php echo $i ?>);" placeholder="<?php echo $label_campo_add_01 ?>"></td>

                <td class="art<?php echo $i ?>" align="center" valign="top"><input type="text"  class="art<?php echo $i ?> fc_fab" name="campo_add_02<?php echo $i ?>" id="campo_add_02<?php echo $i ?>" value="<?php echo $campo_add_02 ?>"  onBlur="save_fc(<?php echo $i ?>);" placeholder="<?php echo $label_campo_add_02 ?>"></td>
                <?php } ?>
                <!-- costo -->
                <td class="art<?php echo $i ?>" align="center" valign="top"><input class="art<?php echo $i ?> fc_costo" name="costo<?php echo $i ?>" id="costo<?php echo $i ?>" value="<?php echo $costo ?>" onkeyup="puntoa($(this));tot();tipo_descuento($('#tipo_op'),$('#costo<?php echo $i ?>'),$('#pvp<?php echo $i ?>'),$('#util<?php echo $i ?>'),$('#iva<?php echo $i ?>'),'<?php echo $redondear_pvp_costo ?>',<?php echo $i ?>);" type="text"  onBlur="save_fc(<?php echo $i ?>);" ></td>

                <!-- dcto -->
                <td class="art<?php echo $i ?>" align="center" valign="top"><input class="art<?php echo $i ?> fc_dcto" name="dcto<?php echo $i ?>" id="dct<?php echo $i ?>" value="<?php echo $dcto*1 ?>"  type="text" onKeyUp="tipo_descuento($('#tipo_op'),$('#costo<?php echo $i ?>'),$('#pvp<?php echo $i ?>'),$('#util<?php echo $i ?>'),$('#iva<?php echo $i ?>'),'<?php echo $redondear_pvp_costo ?>',<?php echo $i ?>);tot();"  onChange="save_fc(<?php echo $i ?>);"></td>
               ...
               <!-- imp. saludable -->
               <?php 
                $onChangeFunction="tipo_descuento($('#tipo_op'),$('#costo$i'),$('#pvp$i'),$('#util$i'),$('#iva$i'),'$redondear_pvp_costo',$i);tot();save_fc($i)";
                $formsElements = new lib_CommonFormsElements();
                $impuestoSaludableForm = $formsElements->impuestoSaludable($onChangeFunction,$impuesto_saludable,$i);
               ?>
               <td class="art<?php echo $i ?>" align="center" valign="top"> <?php echo $impuestoSaludableForm;?></td>

                <!-- iva -->
                <td class="art<?php echo $i ?>" align="center" valign="top"><input onkeyup="tipo_descuento($('#tipo_op'),$('#costo<?php echo $i ?>'),$('#pvp<?php echo $i ?>'),$('#util<?php echo $i ?>'),$('#iva<?php echo $i ?>'),'<?php echo $redondear_pvp_costo ?>',<?php echo $i ?>);tot();" class="art<?php echo $i ?> fc_iva" name="iva<?php echo $i ?>" id="iva<?php echo $i ?>" value="<?php echo $Iva ?>"  type="text" onChange="save_fc(<?php echo $i ?>);"></td>

                <!-- impConsumo -->
                <td class="art<?php echo "$i $classHide_consumo" ?>" align="center" valign="top"><input onkeyup="tipo_descuento($('#tipo_op'),$('#costo<?php echo $i ?>'),$('#pvp<?php echo $i ?>'),$('#util<?php echo $i ?>'),$('#iva<?php echo $i ?>'),'<?php echo $redondear_pvp_costo ?>',<?php echo $i ?>);tot();" class="art<?php echo "$i $classHide_consumo" ?> fc_uti" name="impuesto_consumo<?php echo $i ?>" id="impuesto_consumo<?php echo $i ?>" value="<?php echo $impuesto_consumoRow ?>"  type="text" onChange="save_fc(<?php echo $i ?>);"></td>


                <!-- pvp -->
                <td class="art<?php echo $i ?>" align="center" valign="top"><input class="art<?php echo $i ?> fc_pvp" name="pvp<?php echo $i ?>" id="pvp<?php echo $i ?>" value="<?php echo $pvp ?>" type="text" onKeyUp="tipo_descuento($('#tipo_op'),$('#costo<?php echo $i ?>'),$('#pvp<?php echo $i ?>'),$('#util<?php echo $i ?>'),$('#iva<?php echo $i ?>'),'<?php echo $redondear_pvp_costo ?>',<?php echo $i ?>);puntoa($(this));tot();" onBlur="save_fc(<?php echo $i ?>);" ></td>

 <?php if($MODULES["PVP_CREDITO"]==1){ ?>
                <!-- pvpCre -->
                <td class="art<?php echo $i ?>" align="center" valign="top"><input class="art<?php echo $i ?> fc_pvp" name="pvpCre<?php echo $i ?>" id="pvpCre<?php echo $i ?>" value="<?php echo $pvpCre ?>" type="text" onKeyUp="puntoa($(this));tot();" onBlur="save_fc(<?php echo $i ?>);" ></td>
 <?php } ?>

  <?php if($MODULES["PVP_MAYORISTA"]==1){ ?>

                <!-- pvpMayorista -->
                <td class="art<?php echo $i ?>" align="center" valign="top"><input class="art<?php echo $i ?> fc_pvp" name="pvpMay<?php echo $i ?>" id="pvpMay<?php echo $i ?>" value="<?php echo $pvpMay ?>" type="text" onKeyUp="puntoa($(this));tot();" onBlur="save_fc(<?php echo $i ?>);" ></td>
 <?php } ?>
                ...
                <!-- img BORRAR -->
                <td class="art<?php echo $i?>" style="background-color: rgb(255, 255, 255);">
				<?php //echo "<span class=\"uk-hiddens\" style=\"color:red\">$id</span>";
				 ?>
                 <img onMouseUp="eli_fac_com($(this).prop('class'))" class="<?php echo $i ?>" src="Imagenes/delete.png" width="30px" heigth="20px">
                 <a href="#" onClick="copiaRow(<?php echo $i ?>)" class="art<?php echo $i ?> uk-icon-hover uk-icon-medium uk-icon-copy"></a>
                 </td>
              </tr>
...
<button id="addplus" class=" uk-button uk-button-primary uk-button-large uk-width-1-1 " onClick="addinv_mod();" type="button"><i class="uk-icon-plus-circle uk-icon-large"></i>&nbsp;Agregar Producto</button></td>
      </tr>
      <tr>
        <td colspan="14" align="center"></td>
      </tr>
      <tr id="desc">
        <td colspan="3" rowspan="12" align="left" width="700px" ><textarea name="vlr_let" id="vlr_let" readonly="readonly" cols="40" style="width:400px" class="save_fc"><?php echo $val_letras ?></textarea>
          <br />
      ...
      <tr style="background-color: #9C0">
        <th  align="center" colspan="" width="200px">Dcto DESPUES IVA:
          <input placeholder="%" id="DCTO_PRONTO_PAGO" type="text"  value="" name="DCTO_PRONTO_PAGO"  style="width:50px" onKeyUp="calc_per($(this),$('#SUB'),$('#DESCUENTO2'));"/></th>
      ...
      <tr>
        <th  align="center" colspan="">Impuesto Saludable: </th>
        <td align="right"><input name="IMPUESTO_SALUDABLE" id="IMPUESTO_SALUDABLE"   type="text" value="<?php echo money($IMPUESTO_SALUDABLE*1) ?>"  readonly class="save_fc"/></td>
      </tr>
      ...
      <tr>
        ...
        <td align="right"><input name="IVA" id="IVA"   type="text" value="<?php echo money($iva*1) ?>"  readonly class="save_fc"/></td>
         ...
         <tr>
        <th  align="center" colspan="">Imp. Consumo: </th>
        <td align="right"><input name="impuesto_consumo" id="impuesto_consumo"   type="text" value="<?php echo money($impuesto_consumo*1) ?>"  readonly class="save_fc"/></td>
      </tr>
...
<input placeholder="%" id="R_FTE_PER" type="text"  value="" name="R_FTE_PER"  style="width:50px" onKeyUp="check_vals_compra('<?php echo $serial_compra?>', calc_per($(this),$('#SUB'),$('#R_FTE')));" class="save_fc"/></td>
      ...
      <tr  class="uk-hidden">
        <td  align="right" colspan="" >R. IVA:
          <input placeholder="%" id="R_IVA_PER" type="text"  value="" name="R_IVA_PER"  style="width:50px" onKeyUp="check_vals_compra('<?php echo $serial_compra?>',calc_per($(this),$('#IVA'),$('#R_IVA')));" class="save_fc"/></td>
      ...
      <tr>
        <td  align="right" colspan="">R. ICA:
          <input placeholder="%" id="R_ICA_PER" type="text"  value="" name="R_ICA_PER"  style="width:50px" onKeyUp="check_vals_compra('<?php echo $serial_compra?>',calc_per($(this),$('#SUB'),$('#R_ICA')));" class="save_fc"/></td>
      ...
      <tr>
        ...
        <table align="center">
            ...
            <tr valign="middle">
              <td><button type="button"  name="botonG" id="botonSave"   onMouseUp="save_all();" class=" uk-button uk-button-large"><i class=" uk-icon-floppy-o"></i>Guardar</button></td>
              <td><button type="button" name="botonG" id="botonCerrar"   onMouseUp="close_fc(-1);" class=" uk-button uk-button-large"><i class=" uk-icon-minus-square"></i>CERRAR</button></td>
              <td><?php
...
<?php include_once("librerias_compras_JS.php"); ?>
