    ...
    <div class="main">
        ...
        <fieldset><legend><h2>Database Backup</h2></legend>
            <form name="backup" id="backup" method="post">
                <div><label>Host:</label><input type="text" name="host" value="<?php echo $HOST?>" /></div>
                <div class="cls"></div>
                <div><label>Database name:</label><input type="text" name="database" value="<?php echo $BaseDatos?>" /></div>
                <div class="cls"></div>
                <div><label>Database User:</label><input type="text" name="user" value="<?php echo $USU?>" /></div>
                <div class="cls"></div>
                <div><label>Database Password:</label><input type="text" name="password" value="<?php echo $CLA?>" /></div>
                <div class="cls"></div>
