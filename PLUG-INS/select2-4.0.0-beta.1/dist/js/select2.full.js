    ...
    jQuery.extend({
        attr: function( elem, name, value ) {
            ...
            if ( value !== undefined ) {
                ...
                ret = jQuery.find.prop( elem, name );
...
define('select2/selection/base',[
  ...
  BaseSelection.prototype.bind = function (container, $container) {
    ...
    this.$selection.prop('aria-owns', resultsId);
...
define('select2/selection/single',[
  ...
  SingleSelection.prototype.bind = function (container, $container) {
    ...
    container.on('enable', function () {
      self.$selection.prop('tabindex', '0');
    });
...
define('select2/core',[
  ...
  var Select2 = function ($element, options) {
    ...
    this._tabindex = $element.prop('tabindex') || 0;
  ...
  Select2.prototype.destroy = function () {
    ...
    this.$element.prop('tabindex', this._tabindex);
