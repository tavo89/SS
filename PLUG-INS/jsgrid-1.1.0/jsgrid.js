    ...
    Grid.prototype = {
        ...
        _createNoDataRow: function() {
            ...
            return $("<tr>").addClass(this.noDataRowClass)
                .append($("<td>").prop("colspan", this.fields.length).append(noDataContent));
        },
        ...
        _createPagerButton: function(text, css, handler) {
            var $conex = $("<a>").prop("href", EMPTY_HREF)
                .html(text)
                .on("click", $.proxy(handler, this));

            return $("<span>").addClass(css).append($conex);
        },
...
(function(jsGrid, $, undefined) {
    ...
    ControlField.prototype = new Field({
        ...
        _createModeSwitchButton: function() {
            ...
            var updateButtonState = $.proxy(function() {
                $button.prop("title", isInserting ? this.searchModeButtonTooltip : this.insertModeButtonTooltip)
