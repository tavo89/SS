...
// lista columnas a mostrar, separadas por coma ( , ), el str_replace es para quitar los espacios en balnco entre columnas, que genera error en la consulta SQL
$columns=str_replace(' ', '',"id,nombre_grupo");
...
$modColumns=str_replace(' ', '',"nombre_grupo");
...
$ORDER_BY="ORDER BY nombre_grupo";
...
//
crear_any_form("$tabla",$columnas2,$tipoCol,$default, " function(){ return true;}", "successAny","Grupos difusi&oacute;n","",$selecOPTColumns2);
?>
<h1 align="center"><i class="uk-icon uk-icon-envelope-o"></i> &nbsp;GRUPOS DIFUSI&Oacute;N SMS </h1>
