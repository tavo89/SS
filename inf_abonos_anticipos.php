...
$campo1="nom_cli";
$nom_cli="";
if(isset($_SESSION[$campo1]) && !empty($_SESSION[$campo1])){$nom_cli=$_SESSION[$campo1];$B=" AND ((select nombre from usuarios WHERE usuarios.id_usu=comprobante_ingreso.id_cli LIMIT 1)='$nom_cli' OR id_cli='$nom_cli')";}
...
<span align="center" style="font-size:24px"><B>ABONOS ANTICIPOS</B></span>
</p>
</td>
...
$columns="a.id,a.num_com,a.cod_su,a.fecha,a.valor,a.estado,a.cajero,a.num_exp,a.tipo_pago,e.nom_cli,e.des,a.concepto";
$sql = "SELECT  $columns FROM comp_anti a INNER JOIN exp_anticipo e ON a.num_exp=e.num_exp WHERE a.cod_su=$codSuc $A ORDER BY num_com DESC";  
//echo $sql;
		...
		$('.tablaDataTables').DataTable({
			language: {url: 'locales/es.json'},
                ...
                // Data URL generated by http://dataurl.net/#dataurlmaker
                    ...
                    {extend: 'print',footer:true,title: 'Abonos Anticipos ',
