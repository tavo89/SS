...
$FILTRO_SEDES_FAC="AND cod_su=$codSuc";
...
if(!empty($_REQUEST["fe_i"]) && !empty($_REQUEST["fe_f"])){
$fechaI=r("fe_i");
$fechaF=r("fe_f");
	$A=" AND (DATE(fecha)>='$fechaI' AND DATE(fecha)<='$fechaF') ";
}
...
$campo1="nom_cli";
$nom_cli="";
//if(isset($_SESSION[$campo1]) && !empty($_SESSION[$campo1])){$nom_cli=$_SESSION[$campo1];$B=" AND ((select CONCAT(nombre,' ',snombr, ' ',apelli) as nombre  from usuarios WHERE usuarios.id_usu=comprobante_ingreso.id_cli LIMIT 1)='$nom_cli' OR id_cli='$nom_cli')";}

$idCli=r("idCli");
if($idCli=="arqueo_general")$B="";
/////////////////////////////////////////////////////////////////////////////////////////
...
<body>
<div style=" top:0cm; width:21.5cm;  padding:15px;">
<table align="center" width="100%">
<tr>
 
<td valign="top" colspan="2">
<p align="left" style="font-size:12px;">
<span align="center" style="font-size:24px"><B>ABONOS CARTERA</B></span>
</p>
</td>
...
$nomSql="(select CONCAT(nombre,' ',snombr, ' ',apelli) as nombre from usuarios WHERE usuarios.id_usu=comprobante_ingreso.id_cli LIMIT 1) as nom_cli";
$dirSql="(select dir from usuarios WHERE usuarios.id_usu=comprobante_ingreso.id_cli LIMIT 1) as dir";

$columns="concepto,num_com,num_fac,cod_su,fecha,fecha_cuota,valor,anulado,pre, $nomSql,$dirSql,id_cli";
$sql = "SELECT  $columns FROM comprobante_ingreso WHERE cod_su!=''  AND anulado!='ANULADO' $FILTRO_SEDES_FAC $A $B ORDER BY num_com DESC "; 
//echo $sql;
...
<!--<th width="200">Fecha Cuota</th><th width="250">No. Factura</th>
...
<!--<td><?php// echo $fecha_cuotas; ?></td><td><?php //echo $num_fac; ?></td>
...
<tr>
<td></td><td></td><td></td>
<td colspan="">TOTAL ABONOS</th><th colspan="" align="right"><?php echo money_dt($TOT_ABON); ?></td><td></td>
</tr>
 </tfoot>
</tbody>
</table>
		...
		$('.tablaDataTables').DataTable({
			language: {url: 'locales/es.json'},
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excelHtml5', title: 'Informe Abonos Cartera '+rangoFecha,footer:true, customize: function ( xlsx ){
                ...
                $('row c[r^="F"]', sheet).each( function () {
                    ...
                    {extend: 'pdf', title: 'Informe Abonos Cartera '+rangoFecha,footer:true,orientation:'landscape',pageSize:'letter',
                ...
                // Data URL generated by http://dataurl.net/#dataurlmaker
                    ...
                    {extend: 'print',footer:true,title: 'Informe Abonos Cartera ',
