...
header("content-disposition: attachment;filename=Ventas x Repuesto $MUN $FechaHoy Hora $hora.xls");
...
<th width=\"200\">
<div style=\"display:inline-block;table-layout:fixed;width:80%;\">Exist. Sistema</div>
</th>
<th width=\"200\">Exist. F&iacute;sicas</th>
...
/*
$sqlTOTexist = "SELECT  COUNT(*) AS total FROM ".tabProductos." INNER JOIN inv_inter ON ".tabProductos.".id_pro=inv_inter.id_pro WHERE  $F2 AND exist>0"; 
...
<body>
<div class="Section1"> 
<h1>Ventas por Repuestos <?php echo "$MUN $FechaHoy Hora $hora" ?></h1>
