...
<span align="center"><B>Ventas Diarias por Productos</B></span>
</p>
</td>
...
$cajera=cajeros_list();
$nomCajero="";
if(!empty($CodCajero))$nomCajero=$cajera[$CodCajero];
?>


<tr>
<td><b>Cajero </b></td><td width="50px"></td><td colspan=""><b><?php echo $nomCajero ?></b></td>
</tr>
</table>
</td>
</tr>
<tr>
<td colspan=""><b>Facturas POS </b>IMPRESORA: <?PHP ECHO  "BIXOLON MODELO: SRP-350 S/N: IMPCHKA10110096" ?><br>
...
<th>IVA</th>
<th align="center" width="80">TOT</th>
<!--
<th width="80" align="center">Sub 16%</th>
<th width="80" align="center">Sub 5%</th>
<th width="80" align="center">NO GRAVADAS</th>
-->
...
$sql="SELECT cod_barras,nom_cli,art_fac_ven.num_fac_ven, precio,des,art_fac_ven.sub_tot,art_fac_ven.iva,cant,ref, TIME(fecha) as hora, DATE(fecha) as fe, tipo_venta,tipo_cli,vendedor,fac_venta.prefijo,art_fac_ven.prefijo pre,cod_caja FROM fac_venta INNER JOIN art_fac_ven ON fac_venta.num_fac_ven=art_fac_ven.num_fac_ven WHERE fac_venta.prefijo=art_fac_ven.prefijo AND fac_venta.nit=art_fac_ven.nit AND art_fac_ven.nit=$codSuc $filtroCaja    AND (DATE(fecha)>='$fechaI' AND DATE(fecha)<='$fechaF' $filtroHora) $filtroNOanuladas";
...
while($row=$rs->fetch())
{
    ...
    <td width="center"><?php echo "$pre $num_fac" ?></td>
   
    <td align="left"><?php echo $nomCli ?></td>
    ...
    <?php
	/*if($IVA==16) echo "<td align=\"center\">$subTot</td><td align=\"center\">0</td><td align=\"center\">0</td>";
	else if($IVA==5)echo "<td align=\"center\">0</td><td align=\"center\">$subTot</td><td align=\"center\">0</td>";
	else if($IVA==0)echo "<td align=\"center\">0</td><td align=\"center\">0</td><td align=\"center\">$subTot</td>";
	*/
	?>
...
<?php
$sql="SELECT art_fac_ven.num_fac_ven, precio,des,art_fac_ven.sub_tot,art_fac_ven.iva,cant,ref, TIME(fecha) as hora, DATE(fecha) as fe, tipo_venta,tipo_cli,vendedor,fac_venta.prefijo,art_fac_ven.prefijo pre,cod_caja FROM fac_venta INNER JOIN art_fac_ven ON fac_venta.num_fac_ven=art_fac_ven.num_fac_ven WHERE fac_venta.prefijo=art_fac_ven.prefijo AND fac_venta.nit=art_fac_ven.nit AND art_fac_ven.nit=$codSuc $filtroCaja AND DATE(fecha_anula)>='$fechaI' AND DATE(fecha_anula)<='$fechaF' $filtroHoraAnula AND DATE(fecha)!=DATE(fecha_anula)";
$rs=$linkPDO->query($sql);
...
<tfoot id="asd11">
      ...
      <td></td>
       <td></td>
        ...
        <td>
            <span ><?PHP echo money3(redondeo($TOT_VENTAS0516[1][1])) ?></span>
        </td>
</tfoot>
</table>

<hr align="center" width="100%" />
<table align="left" width="100%" class="display table table-striped table-bordered table-hover">
<tr valign="top">
<td>
<table style="font-size:12px" cellspacing="0" class="display table table-striped table-bordered table-hover">
<tr>
<td colspan="">VENTAS <?php echo $fac_ven_etiqueta_nogravados;?>:</td><td> <span ><?PHP  echo money3(redondeo($TOT_VENTAS0516[0][0])) ?></span></td>
</tr>
<tr>
<td colspan="">BASE IVA 5%:</td><td><span ><?PHP echo money3($TOT_VENTAS0516[5][1]) ?></span></td>
</tr>
<tr>

<td colspan="">VALOR IVA 5%:</td><td><span ><?PHP echo money3($TOT_VENTAS0516[5][2]) ?></span></td>
</tr>
<tr>
<td colspan="">BASE IVA 16%:</td><td><span ><?PHP echo money3($TOT_VENTAS0516[16][1]) ?></span></td>
</tr>
<tr>

<td colspan="">VALOR IVA 16%:</td><td><span ><?PHP echo money3($TOT_VENTAS0516[16][2]) ?></span></td>
</tr>

<tr>
<td colspan="">VENTAS TOTALES:</td><td> <span ><?PHP echo money3(redondeo($TOT_VENTAS0516[1][1])) ?></span></td>
</tr>

</table></td>
<!--
<td>
<table style="font-size:11px" cellspacing="0" align="left" class="display table table-striped table-bordered table-hover">
<TR style="font-size:16px; font-weight:bold;">
...
<?php
$rs=$linkPDO->query("SELECT vendedor from fac_venta WHERE nit=$codSuc $filtroCaja AND mecanico!='Fac. Mensual Revisiones' GROUP BY vendedor");
$totVendedores=0;
while($row=$rs->fetch())
{
        ...
        { type: 'numeric-comma', targets: 2 }],*/
			language: {url: 'locales/es.json'},
                ...
                $('row c[r^="F"]', sheet).each( function () {
                    ...
                    {extend: 'pdf', title: 'INFORME DE FACTURAS DE VENTA '+rangoFecha ,orientation:'landscape',pageSize:'letter',footer:true,
