...
$tabla="x_config_nomina";
$codSuCol="cod_su";
$col_id="id";
$columns="id,rango_a1,rango_a2,rango_b1,rango_b2,rango_c1,rango_c2,per_a,per_b,per_c";
$cols=explode(",",$columns);
$maxCols=count($cols);
$colSet[]="";
for($i=0;$i<$maxCols;$i++){$colSet[$i]=$cols[$i];}
$url="metas_ventas_config.php";
...
$sql = "SELECT  $columns FROM $tabla   $ORDER_BY DESC    LIMIT $offset, $limit "; 
//echo $sql;
...
$columnas="cod_su,rango_a1,rango_a2,rango_b1,rango_b2,rango_c1,rango_c2,per_a,per_b,per_c";
$tipoCol=array(0=>"text","text","text","text","text","text","text","text","text","text" );
$default=array(0=>"$codSuc","","","","","","","","","" );
crear_any_form("$tabla",$columnas,$tipoCol,$default, " function(){ return true;}", "successAny","Metas Ventas $SEDES[$codSuc]","");


?>
<h1 align="center"><i class="uk-icon uk-icon-cog"></i>&nbsp;COMISIONES DE VENTAS </h1>
<br><br><br>
