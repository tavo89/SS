...
$columns=str_replace(' ', '',"id,nombre_nodo");
...
//
crear_any_form("$tabla",$columnas2,$tipoCol,$default, " function(){ return true;}", "successAny","Nodos","",$selecOPTColumns2);
?>
<h1 align="center"><i class="uk-icon uk-icon-share-alt"></i> &nbsp;NODOS </h1>
