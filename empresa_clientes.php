...
<span style=\" font-size:24px\"><B>$NOM_NEGOCIO</B></span>
<BR />
OMAR VEGA HERNANDEZ
<BR />
NIT: $NIT_NEGOCIO REGIMEN COMUN
...
$OPC_COMPRAS_REPLACEREF=0;
$OPC_FACVEN_BUSQ_STOCK=1;
$usar_iva=1;
$MAIN_ID_BAR=0;
///// SECCIONES /////////
...
$usar_bsf=0;
$usar_posFac=0;
$tipo_fac_default="POS";


$ventas_credito=0;
$vista_remi="A";
$usar_costo_remi=0;
$lim_dcto=100;/* porcentaje */
//--------------------------------------------------------
$tipo_utilidad="A";
...
$SEDES=array(1,"Principal Cocacola","TAME","ARAUQUITA","TEMBLADOR","PANAMA");
//////////////////////// COMPRAS /////////////////////////////
$impCompra="A";
...
//////////////////////////////// MODULOS///////////////////////////////
$MODULES=array("CARTERA"=>1,"CARROS_RUTAS"=>0,"ANTICIPOS"=>1,"TRASLADOS"=>0,"REMISIONES"=>1,"CARGAR_CARROS"=>0,"GASTOS"=>1,"FLUJO_KARDEX"=>1,"SERVICIOS"=>0,"PVP_CREDITO"=>0,"COTIZACIONES"=>1,"MULTISEDES_UNIFICADAS"=>0,"PAGO_EFECTIVO_TARJETA"=>0,"AUTO_BAN_CLI"=>1,"UN_BAN_CLI2"=>1,"QUICK_FAC_INPUT"=>0,"CUENTAS_BANCOS"=>0,
"VEHICULOS"=>0,
"PVP_MAYORISTA"=>0,
"LIM_FAC_REMI"=>0,
"CUENTAS_PAGAR"=>1,
"BALANCES_CONTABLES"=>1,
"EGRESOS_2"=>1,
"INFORMES_VENTAS_2"=>1,
"ROTACION_INV"=>1,
"MULTISEDES"=>0,
