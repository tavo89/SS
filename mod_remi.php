...
" name="confirm_bono" onChange="" class="save_fc">
                ...
                <td colspan="3" align="left">Tecnico:<br>
     ...
     INNER JOIN tipo_usu b ON a.id_usu=b.id_usu 
     WHERE $filtroUsuarios AND a.estado!='SUSPENDIDO') b ON b.id_usu=a.id_usu   ORDER BY nombre");
		  while($row=$rs->fetch()){
