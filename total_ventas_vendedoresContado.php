...
<span align="center" style="font-size:24px"><B>Nomina Ventas Productos - VETAS DE CONTADO</B></span>
</p>
</td>
...
$total_vendedores=tot_nomina_cajas($fechaI,$fechaF,$codSuc,"","","",$clase,$fab,"B");
...
<tbody>
<?php
$sql="SELECT vendedor from fac_venta WHERE nit=$codSuc AND tipo_venta!='Credito' AND (DATE(fecha)>='$fechaI' AND DATE(fecha)<='$fechaF' ) $filtroNOanuladas GROUP BY vendedor" ;
