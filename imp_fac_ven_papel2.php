...
<div style=" top:0cm; width:21.5cm; height:27.9cm; position:absolute; background-image: url(Imagenes/FORMATO_FACTURA_OTRAS.png); font-weight:bold;">
...
<div style="position: absolute; top:177px; left:132px; width: 0px;" ><b><?php echo "$dia" ?></b></div>
<div style="position: absolute; top:177px; left:190px" ><b><?php echo "$mes" ?></b></div>          
<div style="position: absolute; top:177px; left:250px" ><b><?php echo "$ano" ?></b></div>




<table style="position: absolute; top:211px; left: 72px; width:660px;"   frame="box" cellpadding="2" cellspacing="5">
<tr>
<td><b>COMPRADOR</b></td><td><?php echo "$cliente" ?></td>
<td><b>C.C/NIT</b></td><td><?php echo "$ced" ?></td>
</tr>
<tr>
<td><b>DIRECCI&Oacute;N</b></td><td><?php echo "$dir" ?></td>
<td><b>TEL.</b></td><td><?php echo "$tel" ?></td>
</tr>
<tr>
<td><b>NOTA DE ENTREGA</b></td><td><?php echo "$num_nota_entrega" ?></td>
</tr>
<tr>
<td><b>FORMA PAGO</b></td><td><?php echo "$formaPago" ?></td>
</tr>
 
</table>
 

<table style="position: absolute; top:339px; left: 72px; width:660px;"   frame="box" cellpadding="2" cellspacing="5">
<tr>
<td width="100">Cant.</td>
<td width="360">Descripci&oacute;n</td>
...
$des.="$infoAdd";
 ...
 $top=230;
  ?> 
<div style="position:absolute; left:77px; top:381px;">1</div>
<div style="position:absolute; left:519px; top:381px;"><?php echo money($pvp) ?></div>
<div style="position:absolute; left:657px; top:381px;"><?php echo money($sub_tot) ?></div>   
...
<div style="position: absolute; left:587px; top:900px; z-index:2"><?php echo $fac_ven_etiqueta_nogravados;?></div>
<div style="position: absolute; left:657px; top:900px; z-index:2"><?php echo money($SUB*1) ?></div>

<div style="position:absolute; left:587px; top:920px">IVA</div>
<div style="position:absolute; left:657px; top:920px"><?php echo money($IVA*1) ?></div>

<div style="position:absolute; left:587px; top:940px">TOTAL</div>
<div style="position:absolute; left:657px; top:940px"><?php echo money($TOT*1) ?></div>
