...
<td><?php echo money3( $FOOT_IVA5);?></td><td><?php echo money3( $FOOT_SUB0);?></td><td><?php echo money3( $TOTAL);?></td><td></td>
</tfoot>
</tbody>
    <?php
	...
	$('.tablaDataTables').DataTable({
        ...
        { type: 'numeric-comma', targets: 2 }],*/
			language: {url: 'locales/es.json'},
				...
				else {echo "doc.content[1].table.widths = [ '10%', '15%', '8%', '8%', '10%', '10%', '7%', '10%', '15%', '10%'];";} ?> 
