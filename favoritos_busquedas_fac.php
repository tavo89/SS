...
$codSuCol="cod_su";
$col_id="id";
$columns="id,nombre_clase";
$cols=explode(",",$columns);
$maxCols=count($cols);
$colSet[]="";
for($i=0;$i<$maxCols;$i++){$colSet[$i]=$cols[$i];}
$url="favoritos_busquedas_fac.php";
$ORDER_BY="ORDER BY nombre_clase";
...
$columnas="cod_su,nombre_clase";
$tipoCol=array(0=>"text","text");
$default=array(0=>"$codSuc","" );
crear_any_form("$tabla",$columnas,$tipoCol,$default, " function(){ return true;}", "successAny","Mesas $SEDES[$codSuc]","");


?>
<h1 align="center">Favoritos Busquedas</h1>
<br><br><br>
...
$iconOpt="remove ";	
?>
<tr  bgcolor="#FFF" style="<?php echo "$fontColor";?>">
...
<a class="uk-button" onClick="<?php echo $FunctPop ?>"><i class="uk-icon-<?php echo $iconOpt ?>"></i></a>
</td>
</tr>
</table>
