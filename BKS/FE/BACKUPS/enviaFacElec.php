...
$sql="SELECT estado_factura_elec FROM fac_venta WHERE num_fac_ven='$num_fac' AND prefijo='$prefijo' 
...
$resp = enviaDocumentoDian($urlApi,$tokenDianOperaciones,$camposFactura,$formateaJson);
...
echo $resp;
	...
	$sqlB = "UPDATE fac_venta SET estado_factura_elec = '1',
    resp_dian = '".$respArr['dian_status']."',
	cufe = '".$respArr['cufe']."'
    WHERE num_fac_ven='$num_fac' AND prefijo='$prefijo'
	          AND nit='$codSuc' $filtroHash";
    t2($sqlA,$sqlB);
