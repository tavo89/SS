...
$columns="id_config,des_config,val";
$cols=explode(",",$columns);
$maxCols=count($cols);
$colSet[]="";
for($i=0;$i<$maxCols;$i++){$colSet[$i]=$cols[$i];}
$url="SISTEMA.php";
$ORDER_BY="ORDER BY des_config";
...
$sql = "SELECT  $columns FROM $tabla WHERE  $codSuCol=$codSuc AND user_mod=1 $ORDER_BY DESC    LIMIT $offset, $limit "; 
//echo $sql;
...
<li class=""><a href="#"  data-uk-modal onClick="fix_temp();"  style="cursor:pointer;"><i class="uk-icon-barcode <?php echo $uikitIconSize ?>"></i>&nbsp;FIX Temporales Inventario</a></li>
				...
				<li><a href="<?php echo $url ?>" ><i class="uk-icon-refresh uk-icon-spin <?php echo $uikitIconSize ?>"></i>&nbsp;Recargar P&aacute;g.</a></li>
                 ...
                 <li class=""><a href="SISTEMA_super.php" style="cursor:pointer;">&nbsp;</a></li>
			</ul>
...
*/
?>
<h1 align="center">OPCIONES DE SISTEMA </h1>
