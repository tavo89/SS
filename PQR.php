...
$columns=str_replace(' ', '',"id,fullname,numdoc,dir,municipio,email,telefono,tiporeq,descripcion,estado_respuesta,fecha");
...
$modColumns=str_replace(' ', '',"");
$modColumns=explode(",",$modColumns);

$estadoOkColumns=str_replace(' ', '',"estado_respuesta");
...
?>
<h1 align="center"><i class="uk-icon uk-icon-envelope-o"></i> &nbsp;Peticiones, Quejas y Reclamos </h1>
...
<table border="0" align="center" claslpadding="6px" bgcolor="#000000" class="uk-table uk-table-hover uk-table-striped"  style="font-size:10px;">
<thead>
...
for($i=0;$i<$max;$i++){
 ...
 if(in_array($columnas[$i],$estadoOkColumns)){		
